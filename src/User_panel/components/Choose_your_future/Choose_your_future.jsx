...
import { chakrview, section3_bg, section3_bg2 } from '../../images/Images';
        ...
        >
            ...
            <div className="lg:max-w-[1440px]  m-auto lg:px-[30px] px-[20px] lg:mb-[80px] relative z-[2]">
                <div className="text-center">
                    <h1 className="font-dm-serif lg:text-[56px] md:text-[40px] sm:text-[35px] text-custom-pink text-[27px]">Choose Way to Know Your Future</h1>
                    <p className="lg:text-[20px] md:text-[15px] sm:text-[13px] max-w-[800px] m-auto mt-[12px] text-white">
                    ...
                    >
                        {futureOptions.slice(0, 3).map((option, index) => (
                            <motion.div
                                ...
                                variants={itemVariants} // Apply individual animation to each item
                            >
