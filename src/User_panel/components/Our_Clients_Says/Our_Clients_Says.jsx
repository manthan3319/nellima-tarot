...
const Our_Clients_Says = () => {
    ...
    return (
        <div className='bg-custom-pink relative z-[99] md:py-[100px] sm:py-[40px] overflow-hidden py-[60px]'>
            ...
            <div className='max-w-[1440px] m-auto lg:px-[30px] px-[20px]' ref={ref}>
                <motion.div
                    initial={{ opacity: 0, y: -20 }}
                    animate={inView ? { opacity: 1, y: 0 } : {}}
                    transition={{ duration: 0.5 }}
                    className='flex justify-between md:flex-row flex-col items-center sm:gap-[30px] gap-[30px] md:gap-0'
                >
                        ...
                        >
                            <Slider {...settings}>
                                {testimonials.map(testimonial => (
                                    <motion.div
                                        key={testimonial.id}
                                        className='md:px-[25px] md:text-left text-center px-[13px]'
                                        initial={{ opacity: 0, y: 20 }}
                                        animate={inView ? { opacity: 1, y: 0 } : {}}
